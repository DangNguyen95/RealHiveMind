...
public class WaveUI : MonoBehaviour
{
    ...
    void UpdateCountingUI()
    {
        ...
        {
            waveAnimator.SetBool("Wave Incoming", false);
            waveAnimator.SetBool("Wave Countdown", true);
            Debug.Log("COUNTING");
        }
    ...
    void UpdateSpawningUI()
    {
        ...
        {
            waveAnimator.SetBool("Wave Countdown", false);
            waveAnimator.SetBool("Wave Incoming", true);
